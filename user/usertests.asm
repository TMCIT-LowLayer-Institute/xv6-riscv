...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0e250513          	add	a0,a0,226 # 6120 <malloc+0x104>
      ...
      74:	8082                	ret
{
      ...
      84:	0c050513          	add	a0,a0,192 # 6140 <malloc+0x124>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0b050513          	add	a0,a0,176 # 6158 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0b250513          	add	a0,a0,178 # 6178 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	07a50513          	add	a0,a0,122 # 6160 <malloc+0x144>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	08650513          	add	a0,a0,134 # 6188 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	08450513          	add	a0,a0,132 # 61b0 <malloc+0x194>
     134:	00006097          	auipc	ra,0x6
     138:	b18080e7          	jalr	-1256(ra) # 5c4c <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	07050513          	add	a0,a0,112 # 61b0 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	06c58593          	add	a1,a1,108 # 61c0 <malloc+0x1a4>
     15c:	00006097          	auipc	ra,0x6
     160:	ac0080e7          	jalr	-1344(ra) # 5c1c <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	04850513          	add	a0,a0,72 # 61b0 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	04c58593          	add	a1,a1,76 # 61c8 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	01c50513          	add	a0,a0,28 # 61b0 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	00650513          	add	a0,a0,6 # 61d0 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f7c50513          	add	a0,a0,-132 # 61f8 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	f68a8a93          	add	s5,s5,-152 # 61f8 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ef650513          	add	a0,a0,-266 # 6208 <malloc+0x1ec>
     ...
     338:	ef450513          	add	a0,a0,-268 # 6228 <malloc+0x20c>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	ee250513          	add	a0,a0,-286 # 6240 <malloc+0x224>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	ece98993          	add	s3,s3,-306 # 6240 <malloc+0x224>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e8250513          	add	a0,a0,-382 # 6240 <malloc+0x224>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	df258593          	add	a1,a1,-526 # 61c8 <malloc+0x1ac>
    ...
    printf("write failed\n");
     ...
     3f0:	e7450513          	add	a0,a0,-396 # 6260 <malloc+0x244>
    ...
    exit(1);
     ...
     40a:	e4250513          	add	a0,a0,-446 # 6248 <malloc+0x22c>
    ...
    printf("open junk failed\n");
     ...
     424:	e2850513          	add	a0,a0,-472 # 6248 <malloc+0x22c>
  ...
  unlink("junk");
     ...
     448:	dfc50513          	add	a0,a0,-516 # 6240 <malloc+0x224>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d20a0a13          	add	s4,s4,-736 # 6270 <malloc+0x254>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c7c50513          	add	a0,a0,-900 # 6278 <malloc+0x25c>
     ...
     61e:	c7650513          	add	a0,a0,-906 # 6290 <malloc+0x274>
     ...
     63c:	c8850513          	add	a0,a0,-888 # 62c0 <malloc+0x2a4>
     ...
     656:	c9e50513          	add	a0,a0,-866 # 62f0 <malloc+0x2d4>
     ...
     674:	c9050513          	add	a0,a0,-880 # 6300 <malloc+0x2e4>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c82a0a13          	add	s4,s4,-894 # 6330 <malloc+0x314>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b12a8a93          	add	s5,s5,-1262 # 61c8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	bdc50513          	add	a0,a0,-1060 # 6338 <malloc+0x31c>
     ...
     77e:	bd650513          	add	a0,a0,-1066 # 6350 <malloc+0x334>
     ...
     798:	b5c50513          	add	a0,a0,-1188 # 62f0 <malloc+0x2d4>
     ...
     7b2:	bd250513          	add	a0,a0,-1070 # 6380 <malloc+0x364>
     ...
     7d0:	bcc50513          	add	a0,a0,-1076 # 6398 <malloc+0x37c>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	99e58593          	add	a1,a1,-1634 # 61c0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	97250513          	add	a0,a0,-1678 # 61b0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	94650513          	add	a0,a0,-1722 # 61b0 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	93250513          	add	a0,a0,-1742 # 61b0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b6c58593          	add	a1,a1,-1172 # 6428 <malloc+0x40c>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	8b250513          	add	a0,a0,-1870 # 61b0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a8650513          	add	a0,a0,-1402 # 63c8 <malloc+0x3ac>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a8a50513          	add	a0,a0,-1398 # 63e8 <malloc+0x3cc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	a8650513          	add	a0,a0,-1402 # 63f8 <malloc+0x3dc>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a8a50513          	add	a0,a0,-1398 # 6418 <malloc+0x3fc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a5650513          	add	a0,a0,-1450 # 63f8 <malloc+0x3dc>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a7050513          	add	a0,a0,-1424 # 6430 <malloc+0x414>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a7250513          	add	a0,a0,-1422 # 6450 <malloc+0x434>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	a5e50513          	add	a0,a0,-1442 # 6470 <malloc+0x454>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	a6e98993          	add	s3,s3,-1426 # 6498 <malloc+0x47c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a9ea8a93          	add	s5,s5,-1378 # 64d0 <malloc+0x4b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9f850513          	add	a0,a0,-1544 # 6470 <malloc+0x454>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	9bc50513          	add	a0,a0,-1604 # 6470 <malloc+0x454>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	99a50513          	add	a0,a0,-1638 # 6478 <malloc+0x45c>
    ...
    exit(1);
     ...
     b00:	9ac50513          	add	a0,a0,-1620 # 64a8 <malloc+0x48c>
     ...
     b1e:	9c650513          	add	a0,a0,-1594 # 64e0 <malloc+0x4c4>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9d250513          	add	a0,a0,-1582 # 6508 <malloc+0x4ec>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9d650513          	add	a0,a0,-1578 # 6528 <malloc+0x50c>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9d250513          	add	a0,a0,-1582 # 6540 <malloc+0x524>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	9c050513          	add	a0,a0,-1600 # 6560 <malloc+0x544>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	96e50513          	add	a0,a0,-1682 # 6560 <malloc+0x544>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	92e50513          	add	a0,a0,-1746 # 6568 <malloc+0x54c>
    ...
    exit(1);
     ...
     c5c:	93050513          	add	a0,a0,-1744 # 6588 <malloc+0x56c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	93c50513          	add	a0,a0,-1732 # 65b0 <malloc+0x594>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	8c050513          	add	a0,a0,-1856 # 6560 <malloc+0x544>
     ...
     cd0:	90450513          	add	a0,a0,-1788 # 65d0 <malloc+0x5b4>
     ...
     cee:	90e50513          	add	a0,a0,-1778 # 65f8 <malloc+0x5dc>
     ...
     d0c:	90850513          	add	a0,a0,-1784 # 6610 <malloc+0x5f4>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	91450513          	add	a0,a0,-1772 # 6638 <malloc+0x61c>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8fe50513          	add	a0,a0,-1794 # 6650 <malloc+0x634>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	91658593          	add	a1,a1,-1770 # 6680 <malloc+0x664>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	8ca50513          	add	a0,a0,-1846 # 6650 <malloc+0x634>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	8b450513          	add	a0,a0,-1868 # 6650 <malloc+0x634>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	89e50513          	add	a0,a0,-1890 # 6650 <malloc+0x634>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	90258593          	add	a1,a1,-1790 # 66c8 <malloc+0x6ac>
  ...
  unlink("unlinkread");
     ...
     e32:	82250513          	add	a0,a0,-2014 # 6650 <malloc+0x634>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	81250513          	add	a0,a0,-2030 # 6660 <malloc+0x644>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	81e50513          	add	a0,a0,-2018 # 6688 <malloc+0x66c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	82250513          	add	a0,a0,-2014 # 66a8 <malloc+0x68c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	82e50513          	add	a0,a0,-2002 # 66d0 <malloc+0x6b4>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	83250513          	add	a0,a0,-1998 # 66f0 <malloc+0x6d4>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	83650513          	add	a0,a0,-1994 # 6710 <malloc+0x6f4>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	74258593          	add	a1,a1,1858 # 6680 <malloc+0x664>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	7da58593          	add	a1,a1,2010 # 6738 <malloc+0x71c>
     f66:	00005517          	auipc	a0,0x5
     f6a:	7ca50513          	add	a0,a0,1994 # 6730 <malloc+0x714>
  ...
  unlink("lf1");
     ...
     f7e:	7b650513          	add	a0,a0,1974 # 6730 <malloc+0x714>
     f82:	00005097          	auipc	ra,0x5
     f86:	cca080e7          	jalr	-822(ra) # 5c4c <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7a450513          	add	a0,a0,1956 # 6730 <malloc+0x714>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	79650513          	add	a0,a0,1942 # 6738 <malloc+0x71c>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	75e58593          	add	a1,a1,1886 # 6738 <malloc+0x71c>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	74850513          	add	a0,a0,1864 # 6738 <malloc+0x71c>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c54080e7          	jalr	-940(ra) # 5c4c <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	73058593          	add	a1,a1,1840 # 6730 <malloc+0x714>
    1008:	00005517          	auipc	a0,0x5
    100c:	73050513          	add	a0,a0,1840 # 6738 <malloc+0x71c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	71458593          	add	a1,a1,1812 # 6730 <malloc+0x714>
    1024:	00006517          	auipc	a0,0x6
    1028:	81c50513          	add	a0,a0,-2020 # 6840 <malloc+0x824>
    ...
    104a:	6fa50513          	add	a0,a0,1786 # 6740 <malloc+0x724>
    ...
    1066:	6f650513          	add	a0,a0,1782 # 6758 <malloc+0x73c>
    ...
    1082:	6f250513          	add	a0,a0,1778 # 6770 <malloc+0x754>
    ...
    109e:	6f650513          	add	a0,a0,1782 # 6790 <malloc+0x774>
    ...
    10ba:	70a50513          	add	a0,a0,1802 # 67c0 <malloc+0x7a4>
    ...
    10d6:	70650513          	add	a0,a0,1798 # 67d8 <malloc+0x7bc>
    ...
    10f2:	70250513          	add	a0,a0,1794 # 67f0 <malloc+0x7d4>
    ...
    110e:	70e50513          	add	a0,a0,1806 # 6818 <malloc+0x7fc>
    ...
    112a:	72250513          	add	a0,a0,1826 # 6848 <malloc+0x82c>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	71098993          	add	s3,s3,1808 # 6868 <malloc+0x84c>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	6e450513          	add	a0,a0,1764 # 6878 <malloc+0x85c>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	69ea0a13          	add	s4,s4,1694 # 6898 <malloc+0x87c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	64c50513          	add	a0,a0,1612 # 6898 <malloc+0x87c>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	5e450513          	add	a0,a0,1508 # 68a0 <malloc+0x884>
    ...
    12e0:	5e450513          	add	a0,a0,1508 # 68c0 <malloc+0x8a4>
    ...
    12fc:	5e850513          	add	a0,a0,1512 # 68e0 <malloc+0x8c4>
...
000000000000134a <badarg>:
{
    ...
    1368:	df498993          	add	s3,s3,-524 # 6158 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	74a78793          	add	a5,a5,1866 # 7b38 <malloc+0x1b1c>
  ...
  if(pid == 0){
    ...
    144e:	13678793          	add	a5,a5,310 # 8580 <malloc+0x2564>
    ...
    1472:	cea50513          	add	a0,a0,-790 # 6158 <malloc+0x13c>
    ...
    148a:	50250513          	add	a0,a0,1282 # 6988 <malloc+0x96c>
    ...
    14aa:	45a50513          	add	a0,a0,1114 # 6900 <malloc+0x8e4>
    ...
    14ca:	45a50513          	add	a0,a0,1114 # 6920 <malloc+0x904>
    ...
    14ec:	45850513          	add	a0,a0,1112 # 6940 <malloc+0x924>
    ...
    150c:	46050513          	add	a0,a0,1120 # 6968 <malloc+0x94c>
    ...
    1526:	8c650513          	add	a0,a0,-1850 # 6de8 <malloc+0xdcc>
  ...
  if(st != 747){
    ...
    1570:	44450513          	add	a0,a0,1092 # 69b0 <malloc+0x994>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    159a:	c1a50513          	add	a0,a0,-998 # 61b0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    15cc:	be8a0a13          	add	s4,s4,-1048 # 61b0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	440a8a93          	add	s5,s5,1088 # 6a10 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    164c:	39850513          	add	a0,a0,920 # 69e0 <malloc+0x9c4>
    ...
    1668:	39450513          	add	a0,a0,916 # 69f8 <malloc+0x9dc>
    ...
    1686:	39e50513          	add	a0,a0,926 # 6a20 <malloc+0xa04>
    ...
    16ac:	b08a0a13          	add	s4,s4,-1272 # 61b0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    16b0:	00005a97          	auipc	s5,0x5
    16b4:	390a8a93          	add	s5,s5,912 # 6a40 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16fe:	ab650513          	add	a0,a0,-1354 # 61b0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    171c:	2e050513          	add	a0,a0,736 # 69f8 <malloc+0x9dc>
    ...
    173a:	31250513          	add	a0,a0,786 # 6a48 <malloc+0xa2c>
...
0000000000001750 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1760:	9fc78793          	add	a5,a5,-1540 # 6158 <malloc+0x13c>
    1764:	fcf43023          	sd	a5,-64(s0)
    1768:	00005797          	auipc	a5,0x5
    176c:	30078793          	add	a5,a5,768 # 6a68 <malloc+0xa4c>
    1770:	fcf43423          	sd	a5,-56(s0)
    1774:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1778:	00005517          	auipc	a0,0x5
    177c:	2f850513          	add	a0,a0,760 # 6a70 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    17ac:	2c850513          	add	a0,a0,712 # 6a70 <malloc+0xa54>
    ...
    17c8:	2cc50513          	add	a0,a0,716 # 6a90 <malloc+0xa74>
    ...
    17e6:	1fe50513          	add	a0,a0,510 # 69e0 <malloc+0x9c4>
    ...
    1802:	27a50513          	add	a0,a0,634 # 6a78 <malloc+0xa5c>
    ...
    1820:	93c50513          	add	a0,a0,-1732 # 6158 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    1854:	25050513          	add	a0,a0,592 # 6aa0 <malloc+0xa84>
    ...
    1870:	24c50513          	add	a0,a0,588 # 6ab8 <malloc+0xa9c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1884:	1f050513          	add	a0,a0,496 # 6a70 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    18ae:	c7e50513          	add	a0,a0,-898 # 6528 <malloc+0x50c>
    ...
    18ca:	13250513          	add	a0,a0,306 # 69f8 <malloc+0x9dc>
  ...
  unlink("echo-ok");
    ...
    18e4:	19050513          	add	a0,a0,400 # 6a70 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	1c650513          	add	a0,a0,454 # 6ad0 <malloc+0xab4>
...
000000000000192e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19d6:	11650513          	add	a0,a0,278 # 6ae8 <malloc+0xacc>
    ...
    1a18:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a64:	0a050513          	add	a0,a0,160 # 6b00 <malloc+0xae4>
    ...
    1a80:	09c50513          	add	a0,a0,156 # 6b18 <malloc+0xafc>
    ...
    1ab2:	08250513          	add	a0,a0,130 # 6b30 <malloc+0xb14>
    ...
    1afe:	05650513          	add	a0,a0,86 # 6b50 <malloc+0xb34>
...
0000000000001b14 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b70:	e7450513          	add	a0,a0,-396 # 69e0 <malloc+0x9c4>
    ...
    1b8c:	fe050513          	add	a0,a0,-32 # 6b68 <malloc+0xb4c>
    ...
    1ba8:	fdc50513          	add	a0,a0,-36 # 6b80 <malloc+0xb64>
...
0000000000001bc8 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1c20:	dc450513          	add	a0,a0,-572 # 69e0 <malloc+0x9c4>
    ...
    1c44:	da050513          	add	a0,a0,-608 # 69e0 <malloc+0x9c4>
...
0000000000001c62 <forkfork>:
{
    ...
    1cbe:	ee650513          	add	a0,a0,-282 # 6ba0 <malloc+0xb84>
    ...
    1cd0:	f30080e7          	jalr	-208(ra) # 5bfc <exit>
{
    ...
    1d16:	e9e50513          	add	a0,a0,-354 # 6bb0 <malloc+0xb94>
...
0000000000001d2c <reparent2>:
{
  ...
  exit(0);
    ...
    1d64:	08850513          	add	a0,a0,136 # 6de8 <malloc+0xdcc>
...
0000000000001d94 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1e02:	fea50513          	add	a0,a0,-22 # 6de8 <malloc+0xdcc>
    ...
    1e2e:	c4e50513          	add	a0,a0,-946 # 6a78 <malloc+0xa5c>
    ...
    1ea0:	d3450513          	add	a0,a0,-716 # 6bd0 <malloc+0xbb4>
    ...
    1ed4:	d1850513          	add	a0,a0,-744 # 6be8 <malloc+0xbcc>
    ...
    1f36:	cde50513          	add	a0,a0,-802 # 6c10 <malloc+0xbf4>
...
0000000000001fba <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fda:	1f250513          	add	a0,a0,498 # 61c8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    2016:	1b6b0b13          	add	s6,s6,438 # 61c8 <malloc+0x1ac>
      link("cat", "x");
    201a:	00005c17          	auipc	s8,0x5
    201e:	c1ec0c13          	add	s8,s8,-994 # 6c38 <malloc+0xc1c>
    2022:	a825                	j	205a <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2024:	85a6                	mv	a1,s1
    2026:	00005517          	auipc	a0,0x5
    202a:	9ba50513          	add	a0,a0,-1606 # 69e0 <malloc+0x9c4>
...
00000000000020be <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20ee:	b9e50513          	add	a0,a0,-1122 # 6c88 <malloc+0xc6c>
    ...
    2112:	b3250513          	add	a0,a0,-1230 # 6c40 <malloc+0xc24>
    ...
    212e:	b2e50513          	add	a0,a0,-1234 # 6c58 <malloc+0xc3c>
    ...
    214a:	b2a50513          	add	a0,a0,-1238 # 6c70 <malloc+0xc54>
...
0000000000002196 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2200:	7e450513          	add	a0,a0,2020 # 69e0 <malloc+0x9c4>
    ...
    2222:	a9250513          	add	a0,a0,-1390 # 6cb0 <malloc+0xc94>
...
0000000000002242 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    22a4:	74050513          	add	a0,a0,1856 # 69e0 <malloc+0x9c4>
    ...
    22d0:	a0450513          	add	a0,a0,-1532 # 6cd0 <malloc+0xcb4>
...
00000000000022f0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2300:	9ec50513          	add	a0,a0,-1556 # 6ce8 <malloc+0xccc>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2332:	9ba50513          	add	a0,a0,-1606 # 6ce8 <malloc+0xccc>
  ...
  close(fd);
    ...
    2368:	99470713          	add	a4,a4,-1644 # 6cf8 <malloc+0xcdc>
    ...
    23bc:	a2050513          	add	a0,a0,-1504 # 6dd8 <malloc+0xdbc>
    ...
    23e0:	a1c50513          	add	a0,a0,-1508 # 6df8 <malloc+0xddc>
...
r_sp()
{
  ...
  __asm__ volatile("mv %0, sp" : "=r" (x) );
    ...
    243e:	9de50513          	add	a0,a0,-1570 # 6e18 <malloc+0xdfc>
    ...
    245a:	58a50513          	add	a0,a0,1418 # 69e0 <malloc+0x9c4>
...
000000000000247a <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24c8:	51c50513          	add	a0,a0,1308 # 69e0 <malloc+0x9c4>
...
00000000000024e8 <manywrites>:
{
  ...
  exit(0);
    ...
    254c:	8a050513          	add	a0,a0,-1888 # 6de8 <malloc+0xdcc>
    ...
    2602:	84250513          	add	a0,a0,-1982 # 6e40 <malloc+0xe24>
    ...
    2622:	c0a50513          	add	a0,a0,-1014 # 6228 <malloc+0x20c>
...
0000000000002640 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    26ba:	48278793          	add	a5,a5,1154 # 7b38 <malloc+0x1b1c>
  ...
  if(ret != -1){
    ...
    26fc:	76050513          	add	a0,a0,1888 # 6e58 <malloc+0xe3c>
    ...
    271a:	1ea50513          	add	a0,a0,490 # 6900 <malloc+0x8e4>
    ...
    2738:	1ec50513          	add	a0,a0,492 # 6920 <malloc+0x904>
    ...
    2758:	1ec50513          	add	a0,a0,492 # 6940 <malloc+0x924>
    ...
    2776:	1f650513          	add	a0,a0,502 # 6968 <malloc+0x94c>
...
000000000000278c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    27c2:	6da50513          	add	a0,a0,1754 # 6e98 <malloc+0xe7c>
  ...
  if(n >= 0){
    ...
    27f2:	6ca50513          	add	a0,a0,1738 # 6eb8 <malloc+0xe9c>
    ...
    2810:	65450513          	add	a0,a0,1620 # 6e60 <malloc+0xe44>
    ...
    282c:	65050513          	add	a0,a0,1616 # 6e78 <malloc+0xe5c>
    ...
    2846:	65e50513          	add	a0,a0,1630 # 6ea0 <malloc+0xe84>
  ...
  if(n >= 0){
    ...
    28a6:	64650513          	add	a0,a0,1606 # 6ee8 <malloc+0xecc>
    ...
    28c0:	5e450513          	add	a0,a0,1508 # 6ea0 <malloc+0xe84>
...
00000000000028ea <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2946:	5ce50513          	add	a0,a0,1486 # 6f10 <malloc+0xef4>
  ...
  for(i = 0; i < 5000; i++){
    ...
    29aa:	58a50513          	add	a0,a0,1418 # 6f30 <malloc+0xf14>
  ...
  if(c != a + 1){
    ...
    2a0e:	58650513          	add	a0,a0,1414 # 6f90 <malloc+0xf74>
    ...
    2a30:	52450513          	add	a0,a0,1316 # 6f50 <malloc+0xf34>
    ...
    2a4c:	52850513          	add	a0,a0,1320 # 6f70 <malloc+0xf54>
...
0000000000002a88 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b96:	41e50513          	add	a0,a0,1054 # 6fb0 <malloc+0xf94>
    ...
    2bb2:	44a50513          	add	a0,a0,1098 # 6ff8 <malloc+0xfdc>
    ...
    2bd2:	44a50513          	add	a0,a0,1098 # 7018 <malloc+0xffc>
    ...
    2bf2:	46a50513          	add	a0,a0,1130 # 7058 <malloc+0x103c>
    ...
    2c0e:	47e50513          	add	a0,a0,1150 # 7088 <malloc+0x106c>
    ...
    2c2e:	49650513          	add	a0,a0,1174 # 70c0 <malloc+0x10a4>
...
0000000000002c44 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c68:	48450513          	add	a0,a0,1156 # 70e8 <malloc+0x10cc>
    2c6c:	00003097          	auipc	ra,0x3
    2c70:	fd0080e7          	jalr	-48(ra) # 5c3c <open>
    2c74:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c76:	00004517          	auipc	a0,0x4
    2c7a:	47250513          	add	a0,a0,1138 # 70e8 <malloc+0x10cc>
  ...
  if(pipe((int *) a) != 0){
    ...
    2cce:	42650513          	add	a0,a0,1062 # 70f0 <malloc+0x10d4>
    ...
    2cea:	42250513          	add	a0,a0,1058 # 7108 <malloc+0x10ec>
    ...
    2d06:	de650513          	add	a0,a0,-538 # 6ae8 <malloc+0xacc>
...
0000000000002d1c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2d30:	3f450513          	add	a0,a0,1012 # 7120 <malloc+0x1104>
  ...
  close(fd);
    ...
    2d78:	c8450513          	add	a0,a0,-892 # 69f8 <malloc+0x9dc>
...
0000000000002d8e <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2dc6:	02650513          	add	a0,a0,38 # 6de8 <malloc+0xdcc>
  ...
  if(pid == 0){
    ...
    2e1c:	fd050513          	add	a0,a0,-48 # 6de8 <malloc+0xdcc>
  ...
  if(pid == 0){
    ...
    2e7c:	f7050513          	add	a0,a0,-144 # 6de8 <malloc+0xdcc>
...
0000000000002fae <execout>:
{
  ...
  exit(0);
    ...
    2ff0:	dfc50513          	add	a0,a0,-516 # 6de8 <malloc+0xdcc>
    ...
    3044:	11850513          	add	a0,a0,280 # 6158 <malloc+0x13c>
    3048:	faa43c23          	sd	a0,-72(s0)
    304c:	00003797          	auipc	a5,0x3
    3050:	17c78793          	add	a5,a5,380 # 61c8 <malloc+0x1ac>
...
0000000000003072 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3082:	27a50513          	add	a0,a0,634 # 72f8 <malloc+0x12dc>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3094:	0c050513          	add	a0,a0,192 # 7150 <malloc+0x1134>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    30aa:	10250513          	add	a0,a0,258 # 71a8 <malloc+0x118c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    30c8:	15c50513          	add	a0,a0,348 # 7220 <malloc+0x1204>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    30e4:	1b050513          	add	a0,a0,432 # 7290 <malloc+0x1274>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30f6:	1f650513          	add	a0,a0,502 # 72e8 <malloc+0x12cc>
  ...
  unlink("12345678901234");
    ...
    3174:	fb850513          	add	a0,a0,-72 # 7128 <malloc+0x110c>
    ...
    3190:	fe450513          	add	a0,a0,-28 # 7170 <malloc+0x1154>
    ...
    31ac:	03050513          	add	a0,a0,48 # 71d8 <malloc+0x11bc>
    ...
    31c8:	08c50513          	add	a0,a0,140 # 7250 <malloc+0x1234>
    ...
    31e4:	0d050513          	add	a0,a0,208 # 72b0 <malloc+0x1294>
    ...
    3200:	10c50513          	add	a0,a0,268 # 7308 <malloc+0x12ec>
...
0000000000003216 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    324c:	0f850513          	add	a0,a0,248 # 7340 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3276:	0de50513          	add	a0,a0,222 # 7350 <malloc+0x1334>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    3306:	03e50513          	add	a0,a0,62 # 7340 <malloc+0x1324>
  ...
  unlink("diskfulldir");
    ...
    331a:	02a50513          	add	a0,a0,42 # 7340 <malloc+0x1324>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3448:	f2c50513          	add	a0,a0,-212 # 7370 <malloc+0x1354>
...
0000000000003456 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3466:	f3e50513          	add	a0,a0,-194 # 73a0 <malloc+0x1384>
  ...
  if(chdir("iputdir") < 0){
    ...
    347a:	f2a50513          	add	a0,a0,-214 # 73a0 <malloc+0x1384>
  ...
  if(unlink("../iputdir") < 0){
    ...
    348e:	f5650513          	add	a0,a0,-170 # 73e0 <malloc+0x13c4>
  ...
  if(chdir("/") < 0){
    ...
    34a2:	f7250513          	add	a0,a0,-142 # 7410 <malloc+0x13f4>
    ...
    34c2:	eea50513          	add	a0,a0,-278 # 73a8 <malloc+0x138c>
    ...
    34de:	ee650513          	add	a0,a0,-282 # 73c0 <malloc+0x13a4>
    ...
    34fa:	efa50513          	add	a0,a0,-262 # 73f0 <malloc+0x13d4>
    ...
    3516:	f0650513          	add	a0,a0,-250 # 7418 <malloc+0x13fc>
...
000000000000352c <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    354a:	e5a50513          	add	a0,a0,-422 # 73a0 <malloc+0x1384>
    ...
    355e:	e4650513          	add	a0,a0,-442 # 73a0 <malloc+0x1384>
    ...
    3572:	e7250513          	add	a0,a0,-398 # 73e0 <malloc+0x13c4>
    ...
    3592:	45250513          	add	a0,a0,1106 # 69e0 <malloc+0x9c4>
    ...
    35ae:	dfe50513          	add	a0,a0,-514 # 73a8 <malloc+0x138c>
    ...
    35ca:	e6a50513          	add	a0,a0,-406 # 7430 <malloc+0x1414>
    ...
    35e6:	e0e50513          	add	a0,a0,-498 # 73f0 <malloc+0x13d4>
...
0000000000003614 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3624:	e2850513          	add	a0,a0,-472 # 7448 <malloc+0x142c>
  ...
  if(chdir("dir0") < 0){
    ...
    3638:	e1450513          	add	a0,a0,-492 # 7448 <malloc+0x142c>
  ...
  if(chdir("..") < 0){
    ...
    364c:	e2050513          	add	a0,a0,-480 # 7468 <malloc+0x144c>
  ...
  if(unlink("dir0") < 0){
    ...
    3660:	dec50513          	add	a0,a0,-532 # 7448 <malloc+0x142c>
    ...
    3680:	d2c50513          	add	a0,a0,-724 # 73a8 <malloc+0x138c>
    ...
    369c:	db850513          	add	a0,a0,-584 # 7450 <malloc+0x1434>
    ...
    36b8:	dbc50513          	add	a0,a0,-580 # 7470 <malloc+0x1454>
    ...
    36d4:	db850513          	add	a0,a0,-584 # 7488 <malloc+0x146c>
...
00000000000036ea <subdir>:
{
  ...
  unlink("ff");
    ...
    36fc:	ed850513          	add	a0,a0,-296 # 75d0 <malloc+0x15b4>
    3700:	00002097          	auipc	ra,0x2
    3704:	54c080e7          	jalr	1356(ra) # 5c4c <unlink>
  if(mkdir("dd") != 0){
    3708:	00004517          	auipc	a0,0x4
    370c:	d9850513          	add	a0,a0,-616 # 74a0 <malloc+0x1484>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3724:	da050513          	add	a0,a0,-608 # 74c0 <malloc+0x14a4>
  ...
  write(fd, "ff", 2);
    ...
    373c:	e9858593          	add	a1,a1,-360 # 75d0 <malloc+0x15b4>
  ...
  if(unlink("dd") >= 0){
    ...
    3756:	d4e50513          	add	a0,a0,-690 # 74a0 <malloc+0x1484>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    376a:	db250513          	add	a0,a0,-590 # 7518 <malloc+0x14fc>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3782:	dc250513          	add	a0,a0,-574 # 7540 <malloc+0x1524>
  ...
  write(fd, "FF", 2);
    ...
    379a:	dda58593          	add	a1,a1,-550 # 7570 <malloc+0x1554>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    37b6:	dc650513          	add	a0,a0,-570 # 7578 <malloc+0x155c>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37fe:	dce58593          	add	a1,a1,-562 # 75c8 <malloc+0x15ac>
    3802:	00004517          	auipc	a0,0x4
    3806:	d3e50513          	add	a0,a0,-706 # 7540 <malloc+0x1524>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    381a:	d2a50513          	add	a0,a0,-726 # 7540 <malloc+0x1524>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3830:	d1450513          	add	a0,a0,-748 # 7540 <malloc+0x1524>
  ...
  if(chdir("dd") != 0){
    ...
    3844:	c6050513          	add	a0,a0,-928 # 74a0 <malloc+0x1484>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3858:	e0c50513          	add	a0,a0,-500 # 7660 <malloc+0x1644>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    386c:	e2850513          	add	a0,a0,-472 # 7690 <malloc+0x1674>
  ...
  if(chdir("./..") != 0){
    ...
    3880:	e4450513          	add	a0,a0,-444 # 76c0 <malloc+0x16a4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3896:	d3650513          	add	a0,a0,-714 # 75c8 <malloc+0x15ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    38d0:	c7450513          	add	a0,a0,-908 # 7540 <malloc+0x1524>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38e8:	e6c50513          	add	a0,a0,-404 # 7750 <malloc+0x1734>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3900:	e8450513          	add	a0,a0,-380 # 7780 <malloc+0x1764>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3918:	b8c50513          	add	a0,a0,-1140 # 74a0 <malloc+0x1484>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    392e:	b7650513          	add	a0,a0,-1162 # 74a0 <malloc+0x1484>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3944:	b6050513          	add	a0,a0,-1184 # 74a0 <malloc+0x1484>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3958:	ebc58593          	add	a1,a1,-324 # 7810 <malloc+0x17f4>
    395c:	00004517          	auipc	a0,0x4
    3960:	df450513          	add	a0,a0,-524 # 7750 <malloc+0x1734>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3974:	ea058593          	add	a1,a1,-352 # 7810 <malloc+0x17f4>
    3978:	00004517          	auipc	a0,0x4
    397c:	e0850513          	add	a0,a0,-504 # 7780 <malloc+0x1764>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3990:	c3c58593          	add	a1,a1,-964 # 75c8 <malloc+0x15ac>
    3994:	00004517          	auipc	a0,0x4
    3998:	b2c50513          	add	a0,a0,-1236 # 74c0 <malloc+0x14a4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    39ac:	da850513          	add	a0,a0,-600 # 7750 <malloc+0x1734>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    39c0:	dc450513          	add	a0,a0,-572 # 7780 <malloc+0x1764>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    39d4:	bf850513          	add	a0,a0,-1032 # 75c8 <malloc+0x15ac>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    39e8:	d9c50513          	add	a0,a0,-612 # 7780 <malloc+0x1764>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39fc:	d5850513          	add	a0,a0,-680 # 7750 <malloc+0x1734>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3a10:	ab450513          	add	a0,a0,-1356 # 74c0 <malloc+0x14a4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3a24:	f4050513          	add	a0,a0,-192 # 7960 <malloc+0x1944>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3a38:	b9450513          	add	a0,a0,-1132 # 75c8 <malloc+0x15ac>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a4c:	a7850513          	add	a0,a0,-1416 # 74c0 <malloc+0x14a4>
  ...
  if(unlink("dd") == 0){
    ...
    3a60:	a4450513          	add	a0,a0,-1468 # 74a0 <malloc+0x1484>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a74:	f6050513          	add	a0,a0,-160 # 79d0 <malloc+0x19b4>
  ...
  if(unlink("dd") < 0){
    ...
    3a88:	a1c50513          	add	a0,a0,-1508 # 74a0 <malloc+0x1484>
    ...
    3aaa:	a0250513          	add	a0,a0,-1534 # 74a8 <malloc+0x148c>
    ...
    3ac6:	a0650513          	add	a0,a0,-1530 # 74c8 <malloc+0x14ac>
    ...
    3ae2:	a0a50513          	add	a0,a0,-1526 # 74e8 <malloc+0x14cc>
    ...
    3afe:	a2650513          	add	a0,a0,-1498 # 7520 <malloc+0x1504>
    ...
    3b1a:	a3a50513          	add	a0,a0,-1478 # 7550 <malloc+0x1534>
    ...
    3b36:	a5650513          	add	a0,a0,-1450 # 7588 <malloc+0x156c>
    ...
    3b52:	a5a50513          	add	a0,a0,-1446 # 75a8 <malloc+0x158c>
    ...
    3b6e:	a6e50513          	add	a0,a0,-1426 # 75d8 <malloc+0x15bc>
    ...
    3b8a:	a7a50513          	add	a0,a0,-1414 # 7600 <malloc+0x15e4>
    ...
    3ba6:	a7e50513          	add	a0,a0,-1410 # 7620 <malloc+0x1604>
    ...
    3bc2:	a8a50513          	add	a0,a0,-1398 # 7648 <malloc+0x162c>
    ...
    3bde:	a9650513          	add	a0,a0,-1386 # 7670 <malloc+0x1654>
    ...
    3bfa:	aaa50513          	add	a0,a0,-1366 # 76a0 <malloc+0x1684>
    ...
    3c16:	ab650513          	add	a0,a0,-1354 # 76c8 <malloc+0x16ac>
    ...
    3c32:	ab250513          	add	a0,a0,-1358 # 76e0 <malloc+0x16c4>
    ...
    3c4e:	ab650513          	add	a0,a0,-1354 # 7700 <malloc+0x16e4>
    ...
    3c6a:	aba50513          	add	a0,a0,-1350 # 7720 <malloc+0x1704>
    ...
    3c86:	ade50513          	add	a0,a0,-1314 # 7760 <malloc+0x1744>
    ...
    3ca2:	af250513          	add	a0,a0,-1294 # 7790 <malloc+0x1774>
    ...
    3cbe:	af650513          	add	a0,a0,-1290 # 77b0 <malloc+0x1794>
    ...
    3cda:	afa50513          	add	a0,a0,-1286 # 77d0 <malloc+0x17b4>
    ...
    3cf6:	afe50513          	add	a0,a0,-1282 # 77f0 <malloc+0x17d4>
    ...
    3d12:	b1250513          	add	a0,a0,-1262 # 7820 <malloc+0x1804>
    ...
    3d2e:	b1e50513          	add	a0,a0,-1250 # 7848 <malloc+0x182c>
    ...
    3d4a:	b2a50513          	add	a0,a0,-1238 # 7870 <malloc+0x1854>
    ...
    3d66:	b3650513          	add	a0,a0,-1226 # 7898 <malloc+0x187c>
    ...
    3d82:	b3a50513          	add	a0,a0,-1222 # 78b8 <malloc+0x189c>
    ...
    3d9e:	b3e50513          	add	a0,a0,-1218 # 78d8 <malloc+0x18bc>
    ...
    3dba:	b4a50513          	add	a0,a0,-1206 # 7900 <malloc+0x18e4>
    ...
    3dd6:	b4e50513          	add	a0,a0,-1202 # 7920 <malloc+0x1904>
    ...
    3df2:	b5250513          	add	a0,a0,-1198 # 7940 <malloc+0x1924>
    ...
    3e0e:	b5e50513          	add	a0,a0,-1186 # 7968 <malloc+0x194c>
    ...
    3e2a:	7da50513          	add	a0,a0,2010 # 7600 <malloc+0x15e4>
    ...
    3e46:	b4650513          	add	a0,a0,-1210 # 7988 <malloc+0x196c>
    ...
    3e62:	b4a50513          	add	a0,a0,-1206 # 79a8 <malloc+0x198c>
    ...
    3e7e:	b5e50513          	add	a0,a0,-1186 # 79d8 <malloc+0x19bc>
    ...
    3e9a:	b6250513          	add	a0,a0,-1182 # 79f8 <malloc+0x19dc>
...
0000000000003eb0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3ec0:	b5450513          	add	a0,a0,-1196 # 7a10 <malloc+0x19f4>
  ...
  if(chdir("dots") != 0){
    ...
    3ed2:	b4250513          	add	a0,a0,-1214 # 7a10 <malloc+0x19f4>
  ...
  if(unlink(".") == 0){
    ...
    3ee4:	96050513          	add	a0,a0,-1696 # 6840 <malloc+0x824>
  ...
  if(unlink("..") == 0){
    ...
    3ef6:	57650513          	add	a0,a0,1398 # 7468 <malloc+0x144c>
  ...
  if(chdir("/") != 0){
    ...
    3f08:	50c50513          	add	a0,a0,1292 # 7410 <malloc+0x13f4>
  ...
  if(unlink("dots/.") == 0){
    ...
    3f1a:	b6250513          	add	a0,a0,-1182 # 7a78 <malloc+0x1a5c>
  ...
  if(unlink("dots/..") == 0){
    ...
    3f2c:	b7850513          	add	a0,a0,-1160 # 7aa0 <malloc+0x1a84>
  ...
  if(unlink("dots") != 0){
    ...
    3f3e:	ad650513          	add	a0,a0,-1322 # 7a10 <malloc+0x19f4>
    ...
    3f5c:	ac050513          	add	a0,a0,-1344 # 7a18 <malloc+0x19fc>
    ...
    3f78:	abc50513          	add	a0,a0,-1348 # 7a30 <malloc+0x1a14>
    ...
    3f94:	ab850513          	add	a0,a0,-1352 # 7a48 <malloc+0x1a2c>
    ...
    3fb0:	ab450513          	add	a0,a0,-1356 # 7a60 <malloc+0x1a44>
    ...
    3fcc:	45050513          	add	a0,a0,1104 # 7418 <malloc+0x13fc>
    ...
    3fe8:	a9c50513          	add	a0,a0,-1380 # 7a80 <malloc+0x1a64>
    ...
    4004:	aa850513          	add	a0,a0,-1368 # 7aa8 <malloc+0x1a8c>
    ...
    4020:	aac50513          	add	a0,a0,-1364 # 7ac8 <malloc+0x1aac>
...
0000000000004036 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    404c:	aa050513          	add	a0,a0,-1376 # 7ae8 <malloc+0x1acc>
  ...
  if(chdir("dirfile") == 0){
    ...
    4068:	a8450513          	add	a0,a0,-1404 # 7ae8 <malloc+0x1acc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    407c:	ab850513          	add	a0,a0,-1352 # 7b30 <malloc+0x1b14>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4094:	aa050513          	add	a0,a0,-1376 # 7b30 <malloc+0x1b14>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    40a8:	a8c50513          	add	a0,a0,-1396 # 7b30 <malloc+0x1b14>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    40bc:	a7850513          	add	a0,a0,-1416 # 7b30 <malloc+0x1b14>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    40d0:	a6458593          	add	a1,a1,-1436 # 7b30 <malloc+0x1b14>
    40d4:	00002517          	auipc	a0,0x2
    40d8:	25c50513          	add	a0,a0,604 # 6330 <malloc+0x314>
  ...
  if(unlink("dirfile") != 0){
    ...
    40ec:	a0050513          	add	a0,a0,-1536 # 7ae8 <malloc+0x1acc>
  ...
  fd = open(".", O_RDWR);
    ...
    4102:	74250513          	add	a0,a0,1858 # 6840 <malloc+0x824>
  ...
  fd = open(".", 0);
    ...
    4118:	72c50513          	add	a0,a0,1836 # 6840 <malloc+0x824>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    412c:	0a058593          	add	a1,a1,160 # 61c8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    4158:	99c50513          	add	a0,a0,-1636 # 7af0 <malloc+0x1ad4>
    ...
    4174:	9a050513          	add	a0,a0,-1632 # 7b10 <malloc+0x1af4>
    ...
    4190:	9b450513          	add	a0,a0,-1612 # 7b40 <malloc+0x1b24>
    ...
    41ac:	99850513          	add	a0,a0,-1640 # 7b40 <malloc+0x1b24>
    ...
    41c8:	9a450513          	add	a0,a0,-1628 # 7b68 <malloc+0x1b4c>
    ...
    41e4:	9b050513          	add	a0,a0,-1616 # 7b90 <malloc+0x1b74>
    ...
    4200:	9bc50513          	add	a0,a0,-1604 # 7bb8 <malloc+0x1b9c>
    ...
    421c:	9c850513          	add	a0,a0,-1592 # 7be0 <malloc+0x1bc4>
    ...
    4238:	9cc50513          	add	a0,a0,-1588 # 7c00 <malloc+0x1be4>
    ...
    4254:	9d850513          	add	a0,a0,-1576 # 7c28 <malloc+0x1c0c>
...
000000000000426a <iref>:
{
    ...
    4288:	9bca0a13          	add	s4,s4,-1604 # 7c40 <malloc+0x1c24>
    mkdir("");
    428c:	00003497          	auipc	s1,0x3
    4290:	4bc48493          	add	s1,s1,1212 # 7748 <malloc+0x172c>
    link("README", "");
    4294:	00002a97          	auipc	s5,0x2
    4298:	09ca8a93          	add	s5,s5,156 # 6330 <malloc+0x314>
    fd = open("xx", O_CREATE);
    429c:	00004997          	auipc	s3,0x4
    42a0:	89c98993          	add	s3,s3,-1892 # 7b38 <malloc+0x1b1c>
    42a4:	a891                	j	42f8 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    42a6:	85da                	mv	a1,s6
    42a8:	00004517          	auipc	a0,0x4
    42ac:	9a050513          	add	a0,a0,-1632 # 7c48 <malloc+0x1c2c>
    ...
    42c8:	99c50513          	add	a0,a0,-1636 # 7c60 <malloc+0x1c44>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    435c:	11098993          	add	s3,s3,272 # 7468 <malloc+0x144c>
    unlink("irefd");
    4360:	00004917          	auipc	s2,0x4
    4364:	8e090913          	add	s2,s2,-1824 # 7c40 <malloc+0x1c24>
    chdir("..");
    4368:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4384:	09050513          	add	a0,a0,144 # 7410 <malloc+0x13f4>
...
00000000000043a4 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    43b4:	8c850513          	add	a0,a0,-1848 # 7c78 <malloc+0x1c5c>
  ...
  if(pid == 0){
    ...
    43d8:	8a450513          	add	a0,a0,-1884 # 7c78 <malloc+0x1c5c>
    ...
    43ee:	8ae50513          	add	a0,a0,-1874 # 7c98 <malloc+0x1c7c>
    ...
    440a:	87a50513          	add	a0,a0,-1926 # 7c80 <malloc+0x1c64>
    ...
    4426:	5be50513          	add	a0,a0,1470 # 69e0 <malloc+0x9c4>
  ...
  if(unlink("oidir") != 0){
    ...
    4454:	82850513          	add	a0,a0,-2008 # 7c78 <malloc+0x1c5c>
    ...
    4468:	76c50513          	add	a0,a0,1900 # 6bd0 <malloc+0xbb4>
...
0000000000004496 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    44a6:	81e50513          	add	a0,a0,-2018 # 7cc0 <malloc+0x1ca4>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    44d2:	7f250513          	add	a0,a0,2034 # 7cc0 <malloc+0x1ca4>
  ...
  sleep(10); // one second
    ...
    450a:	69a50513          	add	a0,a0,1690 # 6ba0 <malloc+0xb84>
    ...
    4524:	7a048493          	add	s1,s1,1952 # 7cc0 <malloc+0x1ca4>
    4528:	4581                	li	a1,0
    452a:	8526                	mv	a0,s1
    ...
    454c:	77850513          	add	a0,a0,1912 # 7cc0 <malloc+0x1ca4>
...
000000000000456c <killstatus>:
{
  ...
  exit(0);
    ...
    45d2:	41250513          	add	a0,a0,1042 # 69e0 <malloc+0x9c4>
    ...
    45f8:	6dc50513          	add	a0,a0,1756 # 7cd0 <malloc+0x1cb4>
...
000000000000460e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4638:	56c50513          	add	a0,a0,1388 # 6ba0 <malloc+0xb84>
  ...
  if(pid2 == 0)
    ...
    4666:	37e50513          	add	a0,a0,894 # 69e0 <malloc+0x9c4>
  ...
  if(pid3 == 0){
    ...
    46aa:	b2258593          	add	a1,a1,-1246 # 61c8 <malloc+0x1ac>
    ...
    46d4:	31050513          	add	a0,a0,784 # 69e0 <malloc+0x9c4>
    ...
    46f0:	60450513          	add	a0,a0,1540 # 7cf0 <malloc+0x1cd4>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    472c:	5e050513          	add	a0,a0,1504 # 7d08 <malloc+0x1cec>
  ...
  printf("kill... ");
    ...
    4758:	5cc50513          	add	a0,a0,1484 # 7d20 <malloc+0x1d04>
  ...
  printf("wait... ");
    ...
    4786:	5ae50513          	add	a0,a0,1454 # 7d30 <malloc+0x1d14>
...
00000000000047b2 <reparent>:
{
  ...
  exit(0);
    ...
    4806:	1de50513          	add	a0,a0,478 # 69e0 <malloc+0x9c4>
    ...
    4822:	34a50513          	add	a0,a0,842 # 6b68 <malloc+0xb4c>
...
0000000000004862 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4898:	25450513          	add	a0,a0,596 # 6ae8 <malloc+0xacc>
    ...
    48cc:	90058593          	add	a1,a1,-1792 # 61c8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4990:	3b450513          	add	a0,a0,948 # 7d40 <malloc+0x1d24>
    ...
    49ac:	03850513          	add	a0,a0,56 # 69e0 <malloc+0x9c4>
    ...
    49f8:	36c50513          	add	a0,a0,876 # 7d60 <malloc+0x1d44>
...
0000000000004a18 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a9c:	2f850513          	add	a0,a0,760 # 7d90 <malloc+0x1d74>
...
0000000000004abc <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4b5e:	26650513          	add	a0,a0,614 # 7dc0 <malloc+0x1da4>
    ...
    4b7a:	27250513          	add	a0,a0,626 # 7de8 <malloc+0x1dcc>
  ...
  fd = open("sharedfd", 0);
    ...
    4bbe:	1f650513          	add	a0,a0,502 # 7db0 <malloc+0x1d94>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4bfe:	20e50513          	add	a0,a0,526 # 7e08 <malloc+0x1dec>
  ...
  unlink("sharedfd");
    ...
    4c3a:	17a50513          	add	a0,a0,378 # 7db0 <malloc+0x1d94>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c60:	1d450513          	add	a0,a0,468 # 7e30 <malloc+0x1e14>
...
0000000000004c80 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4ca4:	1a878793          	add	a5,a5,424 # 7e48 <malloc+0x1e2c>
    4ca8:	f6f43823          	sd	a5,-144(s0)
    4cac:	00003797          	auipc	a5,0x3
    4cb0:	1a478793          	add	a5,a5,420 # 7e50 <malloc+0x1e34>
    4cb4:	f6f43c23          	sd	a5,-136(s0)
    4cb8:	00003797          	auipc	a5,0x3
    4cbc:	1a078793          	add	a5,a5,416 # 7e58 <malloc+0x1e3c>
    4cc0:	f8f43023          	sd	a5,-128(s0)
    4cc4:	00003797          	auipc	a5,0x3
    4cc8:	19c78793          	add	a5,a5,412 # 7e60 <malloc+0x1e44>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4d36:	0b650513          	add	a0,a0,182 # 6de8 <malloc+0xdcc>
    ...
    4db0:	0bc50513          	add	a0,a0,188 # 7e68 <malloc+0x1e4c>
    ...
    4dca:	0b250513          	add	a0,a0,178 # 7e78 <malloc+0x1e5c>
    ...
    4df0:	0a450513          	add	a0,a0,164 # 7e90 <malloc+0x1e74>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e78:	02c50513          	add	a0,a0,44 # 7ea0 <malloc+0x1e84>
...
0000000000004eac <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4eda:	fe2b8b93          	add	s7,s7,-30 # 7eb8 <malloc+0x1e9c>
  for(i = 0; i < N; i++){
    ...
    4f1c:	fa850513          	add	a0,a0,-88 # 7ec0 <malloc+0x1ea4>
    ...
    4f3a:	f8250513          	add	a0,a0,-126 # 7eb8 <malloc+0x1e9c>
  ...
  fd = open(".", 0);
    ...
    4f72:	8d250513          	add	a0,a0,-1838 # 6840 <malloc+0x824>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4fea:	efa50513          	add	a0,a0,-262 # 7ee0 <malloc+0x1ec4>
    ...
    500a:	efa50513          	add	a0,a0,-262 # 7f00 <malloc+0x1ee4>
  ...
  for(i = 0; i < N; i++){
    ...
    5042:	eea50513          	add	a0,a0,-278 # 7f28 <malloc+0x1f0c>
    ...
    505e:	98650513          	add	a0,a0,-1658 # 69e0 <malloc+0x9c4>
...
0000000000005208 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5290:	cd450513          	add	a0,a0,-812 # 7f60 <malloc+0x1f44>
  ...
  for(i = 0; ; i++){
    ...
    52f4:	c8050513          	add	a0,a0,-896 # 7f70 <malloc+0x1f54>
    ...
    5310:	c8450513          	add	a0,a0,-892 # 7f90 <malloc+0x1f74>
    ...
    532c:	c8850513          	add	a0,a0,-888 # 7fb0 <malloc+0x1f94>
    ...
    5348:	c8c50513          	add	a0,a0,-884 # 7fd0 <malloc+0x1fb4>
    ...
    5364:	c9050513          	add	a0,a0,-880 # 7ff0 <malloc+0x1fd4>
    ...
    5380:	c8c50513          	add	a0,a0,-884 # 8008 <malloc+0x1fec>
  ...
  unlink("bigfile.dat");
    ...
    53ae:	bb650513          	add	a0,a0,-1098 # 7f60 <malloc+0x1f44>
    ...
    53d2:	c5a50513          	add	a0,a0,-934 # 8028 <malloc+0x200c>
...
00000000000053e8 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    5408:	c4450513          	add	a0,a0,-956 # 8048 <malloc+0x202c>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5428:	c34c8c93          	add	s9,s9,-972 # 8058 <malloc+0x203c>
    name[0] = 'f';
    ...
    5498:	bd450513          	add	a0,a0,-1068 # 8068 <malloc+0x204c>
  ...
  printf("fsfull test finished\n");
    ...
    550e:	b7e50513          	add	a0,a0,-1154 # 8088 <malloc+0x206c>
    ...
    5564:	b1850513          	add	a0,a0,-1256 # 8078 <malloc+0x205c>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5596:	b0e50513          	add	a0,a0,-1266 # 80a0 <malloc+0x2084>
  ...
  if(pid == 0) {
    ...
    55c6:	b0650513          	add	a0,a0,-1274 # 80c8 <malloc+0x20ac>
    ...
    55ea:	aca50513          	add	a0,a0,-1334 # 80b0 <malloc+0x2094>
    ...
    5612:	ac250513          	add	a0,a0,-1342 # 80d0 <malloc+0x20b4>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5662:	a7a50513          	add	a0,a0,-1414 # 80d8 <malloc+0x20bc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    56bc:	b1098993          	add	s3,s3,-1264 # 61c8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    56ee:	a4650513          	add	a0,a0,-1466 # 8130 <malloc+0x2114>
    ...
    570e:	9e650513          	add	a0,a0,-1562 # 80f0 <malloc+0x20d4>
    ...
    572e:	9e650513          	add	a0,a0,-1562 # 8110 <malloc+0x20f4>
  ...
  while(1){
    ...
    5782:	9d250513          	add	a0,a0,-1582 # 8150 <malloc+0x2134>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    57e0:	994b8b93          	add	s7,s7,-1644 # 8170 <malloc+0x2154>
    int free0 = countfree();
    int free1 = 0;
    ...
    57fa:	992d0d13          	add	s10,s10,-1646 # 8188 <malloc+0x216c>
          return 1;
        }
      }
    }
    ...
    5802:	9aac8c93          	add	s9,s9,-1622 # 81a8 <malloc+0x218c>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58da:	90258593          	add	a1,a1,-1790 # 81d8 <malloc+0x21bc>
  ...
  char *justone = 0;
    ...
    58f8:	8ec58593          	add	a1,a1,-1812 # 81e0 <malloc+0x21c4>
    ...
    590e:	92658593          	add	a1,a1,-1754 # 8230 <malloc+0x2214>
  ...
  int continuous = 0;
    ...
    593a:	8b250513          	add	a0,a0,-1870 # 81e8 <malloc+0x21cc>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5960:	8bc50513          	add	a0,a0,-1860 # 8218 <malloc+0x21fc>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5ce0:	91c50513          	add	a0,a0,-1764 # 85f8 <digits>
    5ce4:	883a                	mv	a6,a4
    5ce6:	2705                	addw	a4,a4,1
    5ce8:	02c5f7bb          	remuw	a5,a1,a2
    5cec:	1782                	sll	a5,a5,0x20
    5cee:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5e72:	78ab8b93          	add	s7,s7,1930 # 85f8 <digits>
    5e76:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e8a:	0992                	sll	s3,s3,0x4
    5e8c:	397d                	addw	s2,s2,-1
    ...
    5ec8:	6b490913          	add	s2,s2,1716 # 8578 <malloc+0x255c>
        while(*s != 0){
    5ecc:	02800593          	li	a1,40
    5ed0:	bff1                	j	5eac <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5ed2:	008b8913          	add	s2,s7,8
...
{
    5f36:	715d                	add	sp,sp,-80
    5f38:	ec06                	sd	ra,24(sp)
    5f3a:	e822                	sd	s0,16(sp)
    5f3c:	1000                	add	s0,sp,32
...
{
    5f64:	711d                	add	sp,sp,-96
    5f66:	ec06                	sd	ra,24(sp)
    5f68:	e822                	sd	s0,16(sp)
    5f6a:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5f9a:	1141                	add	sp,sp,-16
    5f9c:	e422                	sd	s0,8(sp)
    5f9e:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5fa0:	ff050693          	add	a3,a0,-16
    ...
    5fd0:	00e6ea63          	bltu	a3,a4,5fe4 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5fea:	02059813          	sll	a6,a1,0x20
    5fee:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5ffe:	02061593          	sll	a1,a2,0x20
    6002:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    601c:	7139                	add	sp,sp,-64
    601e:	fc06                	sd	ra,56(sp)
    6020:	f822                	sd	s0,48(sp)
    6022:	f426                	sd	s1,40(sp)
    6024:	ec4e                	sd	s3,24(sp)
    6026:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    6028:	02051493          	sll	s1,a0,0x20
    602c:	9081                	srl	s1,s1,0x20
    602e:	04bd                	add	s1,s1,15
    6030:	8091                	srl	s1,s1,0x4
    6032:	0014899b          	addw	s3,s1,1
    6036:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    606c:	3e890913          	add	s2,s2,1000 # 9450 <freep>
  if(p == (char*)-1)
    6070:	5afd                	li	s5,-1
    ...
    6080:	bfc78793          	add	a5,a5,-1028 # fc78 <base>
  ...
  if(p == (char*)-1)
    ...
    60ea:	c798                	sw	a4,8(a5)
        p += p->s.size;
    60ec:	02071693          	sll	a3,a4,0x20
    60f0:	01c6d713          	srl	a4,a3,0x1c
