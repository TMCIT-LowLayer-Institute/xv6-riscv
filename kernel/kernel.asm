...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000190:	88450513          	add	a0,a0,-1916 # 80010a10 <cons>
  ...
  while(n > 0){
    ...
    800001a0:	87448493          	add	s1,s1,-1932 # 80010a10 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    800001a8:	90490913          	add	s2,s2,-1788 # 80010aa8 <cons+0x98>
  while(n > 0){
    ...
    800001ec:	82870713          	add	a4,a4,-2008 # 80010a10 <cons>
    ...
    8000023a:	7da50513          	add	a0,a0,2010 # 80010a10 <cons>
  ...
  return target - n;
    ...
    80000268:	84f72223          	sw	a5,-1980(a4) # 80010aa8 <cons+0x98>
  ...
  release(&cons.lock);
    ...
    8000027e:	79650513          	add	a0,a0,1942 # 80010a10 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    800002e6:	72e50513          	add	a0,a0,1838 # 80010a10 <cons>
  ...
  release(&cons.lock);
    ...
    80000314:	70050513          	add	a0,a0,1792 # 80010a10 <cons>
  ...
  switch(c){
    ...
    80000336:	6de70713          	add	a4,a4,1758 # 80010a10 <cons>
    ...
    80000360:	6b478793          	add	a5,a5,1716 # 80010a10 <cons>
    ...
    8000038e:	71e7a783          	lw	a5,1822(a5) # 80010aa8 <cons+0x98>
    ...
    800003fa:	61a70713          	add	a4,a4,1562 # 80010a10 <cons>
    ...
    80000410:	6af72223          	sw	a5,1700(a4) # 80010ab0 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80000436:	5de78793          	add	a5,a5,1502 # 80010a10 <cons>
    ...
    8000045a:	64c7ab23          	sw	a2,1622(a5) # 80010aac <cons+0x9c>
        wakeup(&cons.r);
    8000045e:	00010517          	auipc	a0,0x10
    80000462:	64a50513          	add	a0,a0,1610 # 80010aa8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000484:	59050513          	add	a0,a0,1424 # 80010a10 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    8000049c:	71078793          	add	a5,a5,1808 # 80020ba8 <devsw>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80000570:	5607a223          	sw	zero,1380(a5) # 80010ad0 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    800005a4:	2ef72823          	sw	a5,752(a4) # 80008890 <panicked>
  for(;;)
...
00000000800005aa <printf>:
{
  ...
  locking = pr.locking;
    ...
    800005ce:	506d2d03          	lw	s10,1286(s10) # 80010ad0 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    8000061e:	49e50513          	add	a0,a0,1182 # 80010ab8 <pr>
  ...
  if(locking)
    ...
    800007a4:	31850513          	add	a0,a0,792 # 80010ab8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    800007c0:	2fc48493          	add	s1,s1,764 # 80010ab8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    8000082c:	2b050513          	add	a0,a0,688 # 80010ad8 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80000858:	03c7a783          	lw	a5,60(a5) # 80008890 <panicked>
...
uartstart()
{
  while(1){
    ...
    80000892:	00a7b783          	ld	a5,10(a5) # 80008898 <uart_tx_r>
    80000896:	00008717          	auipc	a4,0x8
    8000089a:	00a73703          	ld	a4,10(a4) # 800088a0 <uart_tx_w>
    8000089e:	06f70f63          	beq	a4,a5,8000091c <uartstart+0x8e>
{
    ...
    800008c0:	21ca8a93          	add	s5,s5,540 # 80010ad8 <uart_tx_lock>
    uart_tx_r += 1;
    800008c4:	00008497          	auipc	s1,0x8
    800008c8:	fd448493          	add	s1,s1,-44 # 80008898 <uart_tx_r>
    ...
    800008d4:	fd098993          	add	s3,s3,-48 # 800088a0 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
000000008000091e <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000934:	1a850513          	add	a0,a0,424 # 80010ad8 <uart_tx_lock>
  ...
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    ...
    8000094e:	f5673703          	ld	a4,-170(a4) # 800088a0 <uart_tx_w>
    80000952:	00008797          	auipc	a5,0x8
    80000956:	f467b783          	ld	a5,-186(a5) # 80008898 <uart_tx_r>
    8000095a:	02078793          	add	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    8000095e:	00010997          	auipc	s3,0x10
    80000962:	17a98993          	add	s3,s3,378 # 80010ad8 <uart_tx_lock>
    80000966:	00008497          	auipc	s1,0x8
    8000096a:	f3248493          	add	s1,s1,-206 # 80008898 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    8000096e:	00008917          	auipc	s2,0x8
    80000972:	f3290913          	add	s2,s2,-206 # 800088a0 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80000998:	14448493          	add	s1,s1,324 # 80010ad8 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    800009ac:	eee7bc23          	sd	a4,-264(a5) # 800088a0 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000a20:	0bc48493          	add	s1,s1,188 # 80010ad8 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a62:	2e278793          	add	a5,a5,738 # 80021d40 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000a82:	09290913          	add	s2,s2,146 # 80010b10 <kmem>
...
0000000080000b0c <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b20:	ff450513          	add	a0,a0,-12 # 80010b10 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000b34:	21050513          	add	a0,a0,528 # 80021d40 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000b56:	fbe48493          	add	s1,s1,-66 # 80010b10 <kmem>
  ...
  if(r)
    ...
    80000b6e:	fa650513          	add	a0,a0,-90 # 80010b10 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000b9a:	f7a50513          	add	a0,a0,-134 # 80010b10 <kmem>
    ...
    80000da0:	00c587b3          	add	a5,a1,a2
{
    ...
    80000da8:	0705                	add	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdd2c1>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000ee6:	9c670713          	add	a4,a4,-1594 # 800088a8 <started>
  if(cpuid() == 0){
  ...
  scheduler();        
    ...
    80000fe2:	8cf72523          	sw	a5,-1846(a4) # 800088a8 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000ff6:	8be7b783          	ld	a5,-1858(a5) # 800088b0 <kernel_pagetable>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80001070:	3a5d                	addw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdd2b7>
...
000000008000129e <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    800012b2:	60a7b123          	sd	a0,1538(a5) # 800088b0 <kernel_pagetable>
}
    ...
    80001852:	04e58663          	beq	a1,a4,8000189e <copyinstr+0xa2>
{
    ...
    8000188c:	00074703          	lbu	a4,0(a4) # fffffffffffff000 <end+0xffffffff7ffdd2c0>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800018d2:	69248493          	add	s1,s1,1682 # 80010f60 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800018fe:	066a8a93          	add	s5,s5,102 # 80016960 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    8000197c:	1b850513          	add	a0,a0,440 # 80010b30 <pid_lock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800019d8:	f8ca0a13          	add	s4,s4,-116 # 80016960 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    80001a3e:	12650513          	add	a0,a0,294 # 80010b60 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    80001a66:	0ce70713          	add	a4,a4,206 # 80010b30 <pid_lock>
...
forkret(void)
{
  ...
  if (first) {
    ...
    80001a9e:	da67a783          	lw	a5,-602(a5) # 80008840 <first.1>
  ...
  usertrapret();
    ...
    80001ab8:	d807a623          	sw	zero,-628(a5) # 80008840 <first.1>
    fsinit(ROOTDEV);
...
0000000080001c54 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001c64:	30048493          	add	s1,s1,768 # 80010f60 <proc>
    80001c68:	00015917          	auipc	s2,0x15
    80001c6c:	cf890913          	add	s2,s2,-776 # 80016960 <tickslock>
    acquire(&p->lock);
...
0000000080001d22 <userinit>:
{
  ...
  initproc = p;
    ...
    80001d3a:	b8a7b123          	sd	a0,-1150(a5) # 800088b8 <initproc>
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    80001d3e:	03400613          	li	a2,52
    80001d42:	00007597          	auipc	a1,0x7
    80001d46:	b0e58593          	add	a1,a1,-1266 # 80008850 <initcode>
...
0000000080001e00 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    80001ef4:	c5848493          	add	s1,s1,-936 # 80010b48 <wait_lock>
...
0000000080001f42 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001f62:	bd270713          	add	a4,a4,-1070 # 80010b30 <pid_lock>
    80001f66:	9756                	add	a4,a4,s5
    80001f68:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001f6c:	0000f717          	auipc	a4,0xf
    80001f70:	bfc70713          	add	a4,a4,-1028 # 80010b68 <cpus+0x8>
    ...
    80001f80:	bb4a0a13          	add	s4,s4,-1100 # 80010b30 <pid_lock>
    80001f84:	9a3e                	add	s4,s4,a5
    for(p = proc; p < &proc[NPROC]; p++) {
    80001f86:	00015917          	auipc	s2,0x15
    80001f8a:	9da90913          	add	s2,s2,-1574 # 80016960 <tickslock>
  __asm__ volatile("csrr %0, sstatus" : "=r" (x) );
  ...
  __asm__ volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001f9e:	fc648493          	add	s1,s1,-58 # 80010f60 <proc>
...
0000000080001fe2 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    8000200e:	b2670713          	add	a4,a4,-1242 # 80010b30 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80002034:	b0090913          	add	s2,s2,-1280 # 80010b30 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    8000204c:	b2058593          	add	a1,a1,-1248 # 80010b68 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80002170:	df448493          	add	s1,s1,-524 # 80010f60 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000217c:	7e890913          	add	s2,s2,2024 # 80016960 <tickslock>
...
00000000800021ce <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    800021e4:	d8048493          	add	s1,s1,-640 # 80010f60 <proc>
      pp->parent = initproc;
    800021e8:	00006a17          	auipc	s4,0x6
    800021ec:	6d0a0a13          	add	s4,s4,1744 # 800088b8 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    800021f0:	00014997          	auipc	s3,0x14
    800021f4:	77098993          	add	s3,s3,1904 # 80016960 <tickslock>
...
0000000080002228 <exit>:
{
  ...
  if(p == initproc)
    ...
    80002248:	6747b783          	ld	a5,1652(a5) # 800088b8 <initproc>
  ...
  acquire(&wait_lock);
    ...
    800022a4:	8a848493          	add	s1,s1,-1880 # 80010b48 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002312:	c5248493          	add	s1,s1,-942 # 80010f60 <proc>
    80002316:	00014997          	auipc	s3,0x14
    8000231a:	64a98993          	add	s3,s3,1610 # 80016960 <tickslock>
    acquire(&p->lock);
...
00000000800023ce <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    800023f6:	75650513          	add	a0,a0,1878 # 80010b48 <wait_lock>
    ...
    8000240c:	55898993          	add	s3,s3,1368 # 80016960 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    80002410:	0000ec17          	auipc	s8,0xe
    80002414:	738c0c13          	add	s8,s8,1848 # 80010b48 <wait_lock>
    ...
    80002452:	6fa50513          	add	a0,a0,1786 # 80010b48 <wait_lock>
    ...
    80002486:	6c650513          	add	a0,a0,1734 # 80010b48 <wait_lock>
    ...
    800024e2:	a8248493          	add	s1,s1,-1406 # 80010f60 <proc>
    800024e6:	bf65                	j	8000249e <wait+0xd0>
      release(&wait_lock);
    800024e8:	0000e517          	auipc	a0,0xe
    800024ec:	66050513          	add	a0,a0,1632 # 80010b48 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800025d2:	aea48493          	add	s1,s1,-1302 # 800110b8 <proc+0x158>
    800025d6:	00014917          	auipc	s2,0x14
    800025da:	4e290913          	add	s2,s2,1250 # 80016ab8 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    800025fc:	148b8b93          	add	s7,s7,328 # 80008740 <states.0>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800026ce:	bde58593          	add	a1,a1,-1058 # 800082a8 <etext+0x2a8>
    800026d2:	00014517          	auipc	a0,0x14
    800026d6:	28e50513          	add	a0,a0,654 # 80016960 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    800027a6:	1be48493          	add	s1,s1,446 # 80016960 <tickslock>
  ...
  ticks++;
    ...
    800027b8:	10c50513          	add	a0,a0,268 # 800088c0 <ticks>
    ...
    800027e4:	0a07d163          	bgez	a5,80002886 <devintr+0xa8>
{
  ...
  if((scause & 0x8000000000000000L) &&
    ...
    80002848:	a6c50513          	add	a0,a0,-1428 # 800082b0 <etext+0x2b0>
...
0000000080002888 <usertrap>:
{
  ...
  if(killed(p))
    ...
    800028e4:	9f050513          	add	a0,a0,-1552 # 800082d0 <etext+0x2d0>
  ...
  __asm__ volatile("csrr %0, scause" : "=r" (x) );
    ...
    8000295e:	99650513          	add	a0,a0,-1642 # 800082f0 <etext+0x2f0>
  ...
  __asm__ volatile("csrr %0, stval" : "=r" (x) );
    ...
    80002976:	9ae50513          	add	a0,a0,-1618 # 80008320 <etext+0x320>
...
0000000080002998 <kerneltrap>:
{
  ...
  __asm__ volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80002a0c:	98050513          	add	a0,a0,-1664 # 80008388 <etext+0x388>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    80002a84:	cf070713          	add	a4,a4,-784 # 80008770 <states.0+0x30>
  ...
  panic("argraw");
    ...
    80002ac0:	90450513          	add	a0,a0,-1788 # 800083c0 <etext+0x3c0>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    80002c14:	b7878793          	add	a5,a5,-1160 # 80008788 <syscalls>
    ...
    80002c30:	79c50513          	add	a0,a0,1948 # 800083c8 <etext+0x3c8>
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    80002d56:	c0e98993          	add	s3,s3,-1010 # 80016960 <tickslock>
    80002d5a:	00006497          	auipc	s1,0x6
    80002d5e:	b6648493          	add	s1,s1,-1178 # 800088c0 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002d96:	bce50513          	add	a0,a0,-1074 # 80016960 <tickslock>
  ...
  return 0;
    ...
    80002db2:	bb250513          	add	a0,a0,-1102 # 80016960 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    80002dfe:	b6650513          	add	a0,a0,-1178 # 80016960 <tickslock>
    80002e02:	ffffe097          	auipc	ra,0xffffe
    80002e06:	e36080e7          	jalr	-458(ra) # 80000c38 <acquire>
  xticks = ticks;
    80002e0a:	00006497          	auipc	s1,0x6
    80002e0e:	ab64a483          	lw	s1,-1354(s1) # 800088c0 <ticks>
  release(&tickslock);
    80002e12:	00014517          	auipc	a0,0x14
    80002e16:	b4e50513          	add	a0,a0,-1202 # 80016960 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    80002e46:	5a658593          	add	a1,a1,1446 # 800083e8 <etext+0x3e8>
    80002e4a:	00014517          	auipc	a0,0x14
    80002e4e:	b2e50513          	add	a0,a0,-1234 # 80016978 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    80002e5e:	b1e78793          	add	a5,a5,-1250 # 8001e978 <bcache+0x8000>
    80002e62:	0001c717          	auipc	a4,0x1c
    80002e66:	d7e70713          	add	a4,a4,-642 # 8001ebe0 <bcache+0x8268>
    80002e6a:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002e6e:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002e72:	00014497          	auipc	s1,0x14
    80002e76:	b1e48493          	add	s1,s1,-1250 # 80016990 <bcache+0x18>
    ...
    80002e82:	572a0a13          	add	s4,s4,1394 # 800083f0 <etext+0x3f0>
    b->next = bcache.head.next;
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    80002ed6:	aa650513          	add	a0,a0,-1370 # 80016978 <bcache>
    80002eda:	ffffe097          	auipc	ra,0xffffe
    80002ede:	d5e080e7          	jalr	-674(ra) # 80000c38 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002ee2:	0001c497          	auipc	s1,0x1c
    80002ee6:	d4e4b483          	ld	s1,-690(s1) # 8001ec30 <bcache+0x82b8>
    80002eea:	0001c797          	auipc	a5,0x1c
    80002eee:	cf678793          	add	a5,a5,-778 # 8001ebe0 <bcache+0x8268>
    ...
    80002f16:	a6650513          	add	a0,a0,-1434 # 80016978 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002f34:	cf84b483          	ld	s1,-776(s1) # 8001ec28 <bcache+0x82b0>
    80002f38:	0001c797          	auipc	a5,0x1c
    80002f3c:	ca878793          	add	a5,a5,-856 # 8001ebe0 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002f54:	4a850513          	add	a0,a0,1192 # 800083f8 <etext+0x3f8>
    ...
    80002f74:	a0850513          	add	a0,a0,-1528 # 80016978 <bcache>
...
bwrite(struct buf *b)
{
  ...
  virtio_disk_rw(b, 1);
    ...
    80002fe4:	43050513          	add	a0,a0,1072 # 80008410 <etext+0x410>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    8000301c:	96050513          	add	a0,a0,-1696 # 80016978 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80003042:	93a78793          	add	a5,a5,-1734 # 8001e978 <bcache+0x8000>
    80003046:	2b87b703          	ld	a4,696(a5)
    8000304a:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000304c:	0001c717          	auipc	a4,0x1c
    80003050:	b9470713          	add	a4,a4,-1132 # 8001ebe0 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80003064:	91850513          	add	a0,a0,-1768 # 80016978 <bcache>
    ...
    80003080:	39c50513          	add	a0,a0,924 # 80008418 <etext+0x418>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000309c:	8e050513          	add	a0,a0,-1824 # 80016978 <bcache>
  ...
  release(&bcache.lock);
    ...
    800030b2:	8ca50513          	add	a0,a0,-1846 # 80016978 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800030d8:	8a450513          	add	a0,a0,-1884 # 80016978 <bcache>
  ...
  release(&bcache.lock);
    ...
    800030ee:	88e50513          	add	a0,a0,-1906 # 80016978 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    8000311a:	f3e7a783          	lw	a5,-194(a5) # 8001f054 <sb+0x1c>
  ...
  brelse(bp);
    ...
    80003174:	2b050513          	add	a0,a0,688 # 80008420 <etext+0x420>
...
0000000080003180 <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    8000318e:	eb27a783          	lw	a5,-334(a5) # 8001f03c <sb+0x4>
    ...
    800031ae:	e8eb0b13          	add	s6,s6,-370 # 8001f038 <sb>
  ...
  printf("balloc: out of blocks\n");
    ...
    800032b4:	18850513          	add	a0,a0,392 # 80008438 <etext+0x438>
...
bmap(struct inode *ip, uint bn)
{
  ...
  panic("bmap: out of range");
    ...
    800033a8:	0ac50513          	add	a0,a0,172 # 80008450 <etext+0x450>
...
00000000800033b4 <iget>:
{
  ...
  acquire(&itable.lock);
    ...
    800033cc:	c9050513          	add	a0,a0,-880 # 8001f058 <itable>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    800033de:	c9648493          	add	s1,s1,-874 # 8001f070 <itable+0x18>
    800033e2:	0001d697          	auipc	a3,0x1d
    800033e6:	71e68693          	add	a3,a3,1822 # 80020b00 <log>
  ...
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    ...
    80003412:	c4a50513          	add	a0,a0,-950 # 8001f058 <itable>
  ...
  release(&itable.lock);
    ...
    80003464:	00850513          	add	a0,a0,8 # 80008468 <etext+0x468>
...
fsinit(int dev) {
  ...
  memmove(sb, bp->data, sizeof(*sb));
    ...
    80003490:	bac98993          	add	s3,s3,-1108 # 8001f038 <sb>
  ...
  initlog(dev, &sb);
    ...
    800034c4:	b7858593          	add	a1,a1,-1160 # 8001f038 <sb>
    ...
    800034e4:	f9850513          	add	a0,a0,-104 # 80008478 <etext+0x478>
...
00000000800034f0 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003502:	f9258593          	add	a1,a1,-110 # 80008490 <etext+0x490>
    80003506:	0001c517          	auipc	a0,0x1c
    8000350a:	b5250513          	add	a0,a0,-1198 # 8001f058 <itable>
    8000350e:	ffffd097          	auipc	ra,0xffffd
    80003512:	69a080e7          	jalr	1690(ra) # 80000ba8 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003516:	0001c497          	auipc	s1,0x1c
    8000351a:	b6a48493          	add	s1,s1,-1174 # 8001f080 <itable+0x28>
    8000351e:	0001d997          	auipc	s3,0x1d
    80003522:	5f298993          	add	s3,s3,1522 # 80020b10 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003526:	00005917          	auipc	s2,0x5
    8000352a:	f7290913          	add	s2,s2,-142 # 80008498 <etext+0x498>
...
0000000080003550 <_ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    8000355c:	aec72703          	lw	a4,-1300(a4) # 8001f044 <sb+0xc>
    80003560:	4785                	li	a5,1
    80003562:	06e7f463          	bgeu	a5,a4,800035ca <_ialloc+0x7a>
    ...
    8000357c:	ac0a0a13          	add	s4,s4,-1344 # 8001f038 <sb>
    ...
    800035a6:	cf9d                	beqz	a5,800035e4 <_ialloc+0x94>
    brelse(bp);
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    ...
    800035ba:	fce7e3e3          	bltu	a5,a4,80003580 <_ialloc+0x30>
  ...
  printf("ialloc: no inodes\n");
    ...
    800035ce:	ed650513          	add	a0,a0,-298 # 800084a0 <etext+0x4a0>
  ...
  return 0;
    ...
    80003626:	bf5d                	j	800035dc <_ialloc+0x8c>
...
0000000080003628 <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    ...
    80003640:	a145a583          	lw	a1,-1516(a1) # 8001f050 <sb+0x18>
...
00000000800036b6 <idup>:
{
  ...
  acquire(&itable.lock);
    ...
    800036c6:	99650513          	add	a0,a0,-1642 # 8001f058 <itable>
  ...
  release(&itable.lock);
    ...
    800036dc:	98050513          	add	a0,a0,-1664 # 8001f058 <itable>
...
00000000800036f4 <ilock>:
{
  ...
  if(ip->valid == 0){
    ...
    80003726:	d9650513          	add	a0,a0,-618 # 800084b8 <etext+0x4b8>
    ...
    8000373e:	9165a583          	lw	a1,-1770(a1) # 8001f050 <sb+0x18>
    ...
    800037ae:	d1650513          	add	a0,a0,-746 # 800084c0 <etext+0x4c0>
...
00000000800037ba <iunlock>:
{
  ...
  releasesleep(&ip->lock);
    ...
    800037fa:	cda50513          	add	a0,a0,-806 # 800084d0 <etext+0x4d0>
...
00000000800038b2 <iput>:
{
  ...
  acquire(&itable.lock);
    ...
    800038c2:	79a50513          	add	a0,a0,1946 # 8001f058 <itable>
  ...
  release(&itable.lock);
    ...
    800038e0:	77c50513          	add	a0,a0,1916 # 8001f058 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    80003914:	74850513          	add	a0,a0,1864 # 8001f058 <itable>
    ...
    8000394a:	71250513          	add	a0,a0,1810 # 8001f058 <itable>
...
0000000080003e10 <dirlink>:
{
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003eb6:	64e50513          	add	a0,a0,1614 # 80008500 <etext+0x500>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003f0c:	bf890913          	add	s2,s2,-1032 # 80020b00 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003f30:	c0470713          	add	a4,a4,-1020 # 80020b30 <log+0x30>
...
0000000080003f66 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003f6a:	bc67a783          	lw	a5,-1082(a5) # 80020b2c <log+0x2c>
    80003f6e:	0af05d63          	blez	a5,80004028 <install_trans+0xc2>
{
    ...
    80003f8c:	ba8a8a93          	add	s5,s5,-1112 # 80020b30 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003f90:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003f92:	0001d997          	auipc	s3,0x1d
    80003f96:	b6e98993          	add	s3,s3,-1170 # 80020b00 <log>
...
000000008000402a <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80004040:	ac448493          	add	s1,s1,-1340 # 80020b00 <log>
    80004044:	00004597          	auipc	a1,0x4
    80004048:	4cc58593          	add	a1,a1,1228 # 80008510 <etext+0x510>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    8000407e:	ab670713          	add	a4,a4,-1354 # 80020b30 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    800040a8:	a807a423          	sw	zero,-1400(a5) # 80020b2c <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    80004122:	9e250513          	add	a0,a0,-1566 # 80020b00 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    8000414c:	9b848493          	add	s1,s1,-1608 # 80020b00 <log>
  ...
  if(log.outstanding == 0){
    ...
    80004170:	99448493          	add	s1,s1,-1644 # 80020b00 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    8000418c:	97848493          	add	s1,s1,-1672 # 80020b00 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800041fc:	938a8a93          	add	s5,s5,-1736 # 80020b30 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80004200:	0001da17          	auipc	s4,0x1d
    80004204:	900a0a13          	add	s4,s4,-1792 # 80020b00 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80004286:	8a07a523          	sw	zero,-1878(a5) # 80020b2c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    800042ac:	85890913          	add	s2,s2,-1960 # 80020b00 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800042ea:	84a70713          	add	a4,a4,-1974 # 80020b30 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004306:	7fe78793          	add	a5,a5,2046 # 80020b00 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    8000431e:	7e670713          	add	a4,a4,2022 # 80020b00 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80004354:	7b070713          	add	a4,a4,1968 # 80020b00 <log>
  ...
  release(&log.lock);
    ...
    80004366:	79e50513          	add	a0,a0,1950 # 80020b00 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80004392:	1d258593          	add	a1,a1,466 # 80008560 <etext+0x560>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    800044b4:	0c058593          	add	a1,a1,192 # 80008570 <etext+0x570>
    800044b8:	0001c517          	auipc	a0,0x1c
    800044bc:	79050513          	add	a0,a0,1936 # 80020c48 <ftable>
...
filealloc(void)
{
  ...
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    ...
    800044ee:	77648493          	add	s1,s1,1910 # 80020c60 <ftable+0x18>
    800044f2:	0001d717          	auipc	a4,0x1d
    800044f6:	70e70713          	add	a4,a4,1806 # 80021c00 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    8000450a:	74250513          	add	a0,a0,1858 # 80020c48 <ftable>
  ...
  return 0;
    ...
    80004522:	72a50513          	add	a0,a0,1834 # 80020c48 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000454a:	70250513          	add	a0,a0,1794 # 80020c48 <ftable>
  ...
  release(&ftable.lock);
    ...
    80004564:	6e850513          	add	a0,a0,1768 # 80020c48 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    8000459c:	6b050513          	add	a0,a0,1712 # 80020c48 <ftable>
  ...
  release(&ftable.lock);
    ...
    800045de:	66e50513          	add	a0,a0,1646 # 80020c48 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80004778:	43470713          	add	a4,a4,1076 # 80020ba8 <devsw>
    ...
    80004792:	e0250513          	add	a0,a0,-510 # 80008590 <etext+0x590>
    ...
    800047b6:	12078963          	beqz	a5,800048e8 <filewrite+0x136>
{
  ...
  if(f->type == FD_PIPE){
    ...
    80004822:	38a70713          	add	a4,a4,906 # 80020ba8 <devsw>
  ...
  return ret;
    ...
    800048dc:	cc850513          	add	a0,a0,-824 # 800085a0 <etext+0x5a0>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    80004952:	c6258593          	add	a1,a1,-926 # 800085b0 <etext+0x5b0>
...
exec(char *path, char **argv)
{
 ...
 bad:
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004d4c:	87050513          	add	a0,a0,-1936 # 800085b8 <etext+0x5b8>
  ...
  ustack[argc] = 0;
    ...
    80004f1a:	f9078793          	add	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdd250>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = _ialloc(dp->dev, type)) == 0){
    ...
    8000517e:	3d6080e7          	jalr	982(ra) # 80003550 <_ialloc>
  ...
  return ip;
    ...
    800051e8:	3f458593          	add	a1,a1,1012 # 800085d8 <etext+0x5d8>
    ...
    80005200:	3e458593          	add	a1,a1,996 # 800085e0 <etext+0x5e0>
...
0000000080005556 <sys_unlink>:
{
  ...
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    ...
    8000559e:	03e58593          	add	a1,a1,62 # 800085d8 <etext+0x5d8>
    ...
    800055b6:	02e58593          	add	a1,a1,46 # 800085e0 <etext+0x5e0>
  ...
  return 0;
    ...
    80005680:	f6c50513          	add	a0,a0,-148 # 800085e8 <etext+0x5e8>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    800056d0:	f3450513          	add	a0,a0,-204 # 80008600 <etext+0x600>
    ...
    800056e2:	f3a50513          	add	a0,a0,-198 # 80008618 <etext+0x618>
...
free_desc(int i)
{
  ...
  if(disk.free[i])
    ...
    80005dfc:	e0878793          	add	a5,a5,-504 # 80021c00 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005e10:	df478793          	add	a5,a5,-524 # 80021c00 <disk>
  ...
  wakeup(&disk.free[0]);
    ...
    80005e38:	de450513          	add	a0,a0,-540 # 80021c18 <disk+0x18>
...
0000000080005e6c <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005e7c:	7d058593          	add	a1,a1,2000 # 80008648 <etext+0x648>
    80005e80:	0001c517          	auipc	a0,0x1c
    80005e84:	ea850513          	add	a0,a0,-344 # 80021d28 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    80005ef0:	75f70713          	add	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdca1f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    80005f4a:	cba48493          	add	s1,s1,-838 # 80021c00 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005f70:	c9c73703          	ld	a4,-868(a4) # 80021c08 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005f8c:	c7848493          	add	s1,s1,-904 # 80021c00 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800060c8:	c6450513          	add	a0,a0,-924 # 80021d28 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800060dc:	b28b0b13          	add	s6,s6,-1240 # 80021c00 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800060e6:	c46c0c13          	add	s8,s8,-954 # 80021d28 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80006108:	afc70713          	add	a4,a4,-1284 # 80021c00 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80006148:	ad450513          	add	a0,a0,-1324 # 80021c18 <disk+0x18>
  ...
  if(write)
    ...
    80006168:	a9c78793          	add	a5,a5,-1380 # 80021c00 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    8000623e:	aee90913          	add	s2,s2,-1298 # 80021d28 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    8000626a:	99a78793          	add	a5,a5,-1638 # 80021c00 <disk>
    8000626e:	97ba                	add	a5,a5,a4
    80006270:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80006274:	0001c997          	auipc	s3,0x1c
    80006278:	98c98993          	add	s3,s3,-1652 # 80021c00 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    800062a0:	a8c50513          	add	a0,a0,-1396 # 80021d28 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800062d4:	93048493          	add	s1,s1,-1744 # 80021c00 <disk>
    800062d8:	0001c517          	auipc	a0,0x1c
    800062dc:	a5050513          	add	a0,a0,-1456 # 80021d28 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80006358:	9d450513          	add	a0,a0,-1580 # 80021d28 <disk+0x128>
    ...
    80006372:	3a250513          	add	a0,a0,930 # 80008710 <etext+0x710>
